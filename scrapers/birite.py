...
class BiRiteScraper(Scraper):
	...
	def build_categories_list(self):
		...
		url = "https://app.cutanddry.com/catalog/BiRite%20Foodservice%20Distributors/247696227?verifiedVendorId=120984264&categoryId=1&page=1"
		categories = []
		print(f"Loading page...{url}")
		del self.driver.requests
		self.driver.get(url)
