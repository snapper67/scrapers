...
class AlpeakeScraper(CutScraper):
    ...
    # Values to change
    BASE_URL = "https://alpeake.cutanddry.com/catalog/alpeake?verifiedVendorId=214278530&categoryId=1&page=1"

    # These values are pulled from the base URL
    SUB_DOMAIN = "https://alpeake.cutanddry.com"
    VENDOR_URL_NAME = 'alpeake'
    VERIFIED_VENDOR_ID = 214278530

    # This the name of the vendor
    VENDOR_NAME = "Alpeake Seafood"
