...
class DerstinesScraper(CutScraper):

	DEFAULT_DIRECTORY = '/Users/mark/Downloads/scrapers/derstines/'

	# Values to change
	BASE_URL = "https://derstines.cutanddry.com/catalog/Derstines?verifiedVendorId=177866000&categoryId=1&page=1"
  ...
  "data": {
	...
	VENDOR_NAME = "Derstine's"
	VENDOR_URL_NAME = 'Derstines'
